...
#•	The order of the books in the output matches their order in the all_books list.
#PUBLIC TESTCASE	Sample Input
#Book1 Book2 Book3 Book4
#Book2 Book4
#Sample Output
#['Book1', 'Book3']
all_books=list(input("Enter the Books: ").split())
checked_books=list(input("Enter The checked Books: ").split())
available_books=[]
for i in all_books:
